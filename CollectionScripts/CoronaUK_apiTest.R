endpoint <- 'https://api.coronavirus.data.gov.uk/v1/data?filters=areaType=region&structure={"date":"date","newCases":"newCasesBySpecimenDate","areaName":"areaName","cumCases":"cumCasesBySpecimenDate","newDeaths":"newDeathsByDeathDate"}'
